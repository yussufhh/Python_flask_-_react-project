...
const AboutUs = () => {
  ...
  const bgImages = [
    "https://img.freepik.com/free-photo/programming-background-collage_23-2149901782.jpg?ga=GA1.1.324353260.1725517862&semt=ais_hybrid", 
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gray-600 opacity-50 blur-md"></div> {/* Add blur to image for better text contrast */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-white">
        ...
        <section className="flex flex-col md:flex-row justify-between gap-12 mb-16">
          <div className="w-full md:w-1/2">
            <div className="bg-green-500 p-8 rounded-xl shadow-xl hover:shadow-2xl transition duration-500">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            <div className="bg-green-500 p-8 rounded-xl shadow-xl hover:shadow-2xl transition duration-500 text-center">
              <img
            ...
            <div className="bg-green-500 p-8 rounded-xl shadow-xl hover:shadow-2xl transition duration-500 text-center">
              <img
                ...
                className="w-32 h-32 mx-auto rounded-full mb-4"
              />
              <h3 className="text-xl font-semibold text-gray-800">Asha Ali</h3>
